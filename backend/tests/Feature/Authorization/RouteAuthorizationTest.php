...
class RouteAuthorizationTest extends TestCase
{
    ...
    private const ACCESS = ['health' => 'public', 'auth.login' => 'public', 'auth.logout' => 'self', 'auth.me' => 'self', 'auth.password' => 'self', 'admin.users.index' => 'admin', 'admin.users.store' => 'admin', 'admin.users.show' => 'admin', 'admin.users.update' => 'admin', 'admin.workload' => 'admin', 'categories.index' => 'staff', 'categories.show' => 'staff', 'priorities.index' => 'staff', 'statuses.index' => 'staff', 'tickets.index' => 'staff', 'tickets.stats' => 'staff', 'tickets.show' => 'staff', 'tickets.status' => 'staff-write', 'tickets.store' => 'staff-write', 'tickets.update' => 'staff-write', 'categories.store' => 'admin-policy', 'categories.update' => 'admin-policy', 'categories.destroy' => 'admin-policy', 'tickets.destroy' => 'admin-policy', 'tickets.assign' => 'admin-policy', 'tickets.claim' => 'agent-policy', 'tickets.escalate' => 'staff', 'tickets.activities' => 'staff', 'tickets.notes' => 'staff'];
