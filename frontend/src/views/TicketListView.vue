...
<template>
  <main class="mx-auto max-w-7xl space-y-5 px-4 py-7 sm:px-6 lg:px-8">
    ...
    <div v-else-if="store.items.length" class="ui-card overflow-hidden">
        ...
        <table class="ui-table" data-testid="tickets-table">
          <thead class="ui-thead">
            <tr>
              ...
              <th scope="col" class="ui-th" :aria-sort="ariaSort('created_at')">
                <UiSortButton
                  label="Age"
          ...
          <tbody class="ui-tbody">
            ...
            >
              ...
              <td class="ui-td whitespace-nowrap text-xs">
                <span v-if="ticket.assignee" class="flex items-center gap-1.5">
                  <span
